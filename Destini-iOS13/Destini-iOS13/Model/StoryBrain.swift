...
class StoryBrain {
    ...
    func getDirections(_ userChoice : String, _ currStory : Int) -> Int {
        if userChoice == "Choice 1" {
            return self.storyList[currStory].choice1Destination
        } else {
            return self.storyList[currStory].choice2Destination
        }
    }
